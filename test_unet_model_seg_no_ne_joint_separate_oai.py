...
def run_model(gpu=1,
    ...
    for i in range(val_batch_cnt):
        ...
        left_val_predict = model(left_val_batch_X)
        right_val_predict = model(right_val_batch_X)
        ...
        left_val_predict = (left_val_predict + flip_left_val_predict) / 2
        right_val_predict = (right_val_predict + flip_right_val_predict) / 2
        ...
        left_val_predict[left_val_predict > 1] = 1

        right_val_predict[right_val_predict > 1] = 1
